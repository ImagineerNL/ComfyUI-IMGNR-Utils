    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (isPreviewNode || hasSaveControls) {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                if (this.properties.imgnr_slider_val !== undefined) {
                    this.sliderVal = this.properties.imgnr_slider_val;
                } else {
                    this.sliderVal = 50; 
                }
                ...
                if (hasCompareControls) {
                    ...
                    slider.type = "range"; slider.min = "0"; slider.max = "100"; slider.value = this.sliderVal;
                    ...
                    slider.oninput = (e) => {
                        ...
                        this.properties["imgnr_slider_val"] = this.sliderVal;
                        const curImg = imgHolder.querySelector(".imgnr-cur-layer");
                        if (curImg) {
                ...
                if (hasSaveControls) {
                    ...
                    saveBtn.onclick = async () => {
                        ...
                        const payload = {
                            ...
                            embed_workflow: getVal("embed_workflow")
                        };
            ...
            nodeType.prototype.onConfigure = function () {
                ...
                // 3. Restore slider value
                if (this.properties?.imgnr_slider_val !== undefined) {
                    this.sliderVal = this.properties.imgnr_slider_val;
                    if (this.slider) this.slider.value = this.sliderVal;
                }

                // 4. Restore session images (Survives Tab Switching ONLY)
